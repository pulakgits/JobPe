...
import com.codingburn.jobpe.databinding.FragmentGovtJobBinding;
...
public class GovtJobFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGovtJobBinding.inflate(inflater,container,false);

        // LinearLayout Manager
        LinearLayoutManager layoutManager = new LinearLayoutManager(requireContext());
        binding.govtJobRecycler.setLayoutManager(layoutManager);


        databaseReference = FirebaseDatabase.getInstance().getReference();

        databaseReference.child("Job").child("GovtJob").child("GovtJob").orderByChild("jobId")
                .limitToLast(1000000000).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        binding.govtJobRecycler.setAdapter(adapter);
                    }
